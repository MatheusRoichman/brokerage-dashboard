...
const PasswordResetedPage: React.FC = () => {
  return (
    <>
          ...
          <div className="w-full h-full flex flex-col justify-between items-center space-y-6">
            ...
            <Box backgroundColor="gray">
              ...
              <p className="mt-10 md:mt-20">
                Sua senha foi alterada com sucesso! Agora você já pode utilizar
                ela para acessar o sistema.
              </p>
...
export default PasswordResetedPage;
